...
def is_layout_applicable(layout) -> bool:
    ...
    # TODO
        ...
        return False
    elif isinstance(layout, LinearLayout):
        return True
    elif is_cuda():
...
layouts = [
    ...
    BlockedLayout([1, 4], [THREADS_PER_WARP, 1], [1, 4], [1, 0], [1, 1], [1, 1], [0, 1]),  # TODO
    BlockedLayout([1, 4], [1, THREADS_PER_WARP], [2, 2], [0, 1], [1, 1], [1, 1], [0, 1])
]
...
def gen_gather_warp_shuffle_cases():
    ## TODO gcu use THREADS_PER_WARP as 1
    if THREADS_PER_WARP == 32 or THREADS_PER_WARP == 1:
        return [
            ([32, 16], [32, 16], 0,
